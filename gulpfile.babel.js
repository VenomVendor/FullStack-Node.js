...
gulp.task('git-hash', () => {
    const hash = `/**
 * This files is auto-generated by VenomVendor on ${new Date()}
 */
class Hash {
    static short() {
...
gulp.task(
    'default',
    ['git-hash', 'js-self-lint', 'clean', 'minify-html', 'images', 'vendor-js', 'strip-metadata', 'eslint',
        'minify-js', 'styles', 'watch', 'nodemon']
);
export default gulp;
